...
public class JourneyToTheMoon {
    ...
    public JourneyToTheMoon(int nrOfAstronauts) {
    ...
    public static void main(String[] args) {
        Scanner scanner = new Scanner(new StringReader("4 2\n" +
                "0 1\n" +
                "2 3"));
        ...
        JourneyToTheMoon solution = new JourneyToTheMoon(nrOfAstronauts);
